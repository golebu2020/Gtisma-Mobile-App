  ...
  Future<dynamic> loginData(String email, String pass) async {
    if (email.isNotEmpty && pass.isNotEmpty) {
      var response = await http.post(Uri.encodeFull(url), headers: {
        ...
        'email': email,
        'password': pass,
        'firebase_token': UserPreferences().retrieveFirebaseID() != null
            ? UserPreferences().retrieveFirebaseID()
            : "",
        'device_id': UserPreferences().retrieveDeviceID() != null
            ? UserPreferences().retrieveDeviceID()
            : "",
      });
      ...
      if (response.statusCode == 200) {
        ...
        List<String> personalInfo =
            await GetUser().getLoginUser(cooldata['data']);
        UserPreferences()
            .storeSocialLoginName(personalInfo[0] + ' ' + personalInfo[1]);
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: lang.languagTester(nativeLanguage)[17],
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: lang.languagTester(nativeLanguage)[20],
                // labelText: lang.languagTester(
                //     nativeLanguage)[20],
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(50.0),
          ...
          Visibility(
              ...
              child: Container(
                  margin: EdgeInsets.only(
                      right: 0.0278 * width, left: 0.0278 * width),
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: Text(lang.languagTester(nativeLanguage)[25].toUpperCase(),
                style: fontDesign),
            centerTitle: true,
            elevation: 2.0,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextButton(
                          child: Text(
                            lang.languagTester(nativeLanguage)[32],
                            style: TextStyle(
...
Future<bool> _backPressed() {
  ...
  GoogleFonts.fredokaOne(color: Colors.white, fontSize: 15.0);
  var fontDesign2 =
  GoogleFonts.roboto(color: Colors.black87, fontSize: 20.0, fontWeight: FontWeight.bold);
  var fontDesign3 =
  GoogleFonts.roboto(color: Colors.black87, fontSize: 18.0, fontWeight: FontWeight.w400);
  return showDialog(
    context: context,
    builder: (context) => Padding(
      padding: const EdgeInsets.all(10.0),
      child: new AlertDialog(
        title: new Text('Are you sure?', style: fontDesign2),
        content: new Text('Do you want to exit an App', style: fontDesign3),
        backgroundColor:Colors.white,
        actions: <Widget>[
          FlatButton(
