...
import 'package:gtisma/Screens/SelectLanguage.dart' as screenLang;
...
class _OnBoardingPageState extends State<OnBoardingPage> {
   ...
   // debugPrint(prefs.get("LangS"));
    ...
    return WillPopScope(
      ...
      child: IntroductionScreen(
        ...
        pages: [
          PageViewModel(
            ...
            decoration: const PageDecoration(
              ...
              bodyTextStyle: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w100, ),
        ...
        skipFlex: 0,
        nextFlex: 0,
        skip: Text(lang.languagTester(nativeLanguage)[8],style: TextStyle(color: Colors.white, fontSize: 20.0),),
        next: const Icon(Icons.arrow_forward, color: Colors.white),
        done: Text(lang.languagTester(nativeLanguage)[9], style: TextStyle(color: Colors.white, fontSize: 20.0),),
  ...
  Future<bool> _backPressed() {
   // Navigator.pop(context);
    NavigationPreferences().storeSelectLanguage(false);
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => screenLang.SelectLanguage()),
    );
  }
}
