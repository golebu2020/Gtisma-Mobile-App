    ...
    try {
      ...
      if (_start) {
        ...
        if (_controller.value.isRecordingVideo) {
          ...
          setState(() {
            _opacityController.reverse();
            savedVideo = File(videoFile.path);
            vidPath = File(videoFile.path);
          });
        }
      }
    } catch (e) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                top: 0.491071 * height, right: 0.055556 * width),
      ...
      child: Stack(
        children: [
          ...
          Center(
            child: Padding(
              padding: EdgeInsets.only(
                  left: 0.05556 * width, right: 0.05556 * width),
              child: Text(
          ...
          Padding(
            padding:
                EdgeInsets.only(top: 0.3125 * height, right: 0.05556 * width),
            child: RotatedBox(
                quarterTurns: 315,
                child: SizedBox(
